...
SEARCH_TARGET_DB_DIR = PROJECT_ROOT / "data" / "processed" / "search_target_DB"
...
CLIP_BASE_MODEL_PATH   = "Bingsu/clip-vit-large-patch14-ko"   # 백본 freeze 가중치(베이스 모델)
CLIP_LORA_ADAPTER_PATH = "checkpoints/best_model"   # LoRA 파인튜닝 어댑터
